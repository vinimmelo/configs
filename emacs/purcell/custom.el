(custom-set-variables
 ...
 '(custom-enabled-themes '(doom-old-hope sanityinc-tomorrow-bright))
 '(display-fill-column-indicator-character nil)
 '(display-fill-column-indicator-column t)
 '(display-fill-column-indicator-mode-hook nil)
 '(display-line-numbers nil)
 '(display-line-numbers-type 'relative)
 '(display-line-numbers-width 3)
 '(face-font-family-alternatives
   '(("JetBrains Mono Bold" "Hack Bold" "JetBrains Mono" "Hack" "Monospace" "courier" "fixed")
